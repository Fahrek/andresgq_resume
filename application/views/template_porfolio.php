...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>public/css/unicons.css">
  ...
  <body style="background: lightseagreen!important;">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item">
                        <a href="#about" class="nav-link"><span data-hover="About">Sobre mi</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="#project" class="nav-link"><span data-hover="Projects">Proyectos</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="#resume" class="nav-link"><span data-hover="Resume">CV</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="#contact" class="nav-link"><span data-hover="Contact">Contacto</span></a>
                    </li>
                </ul>
            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-md-12 col-12 d-flex align-items-center">
                    <div class="about-text">
                        <small class="small-text">¡Bienvenido <span class="mobile-block">al sitio web de mi portfolio!</span></small>
                        <h1 class="animated animated-text">
                            <span class="mr-2">Saludos, soy</span>
                                <div class="animated-info">
                                    <span class="animated-item">Andres</span>
                                    <span class="animated-item">Diseñador</span>
                                    <span class="animated-item">Desarrollador</span>
                                </div>
                        </h1>

                        <p>Construir un producte amb èxit és un repte. Sóc molt enèrgic en disseny d’experiències d’usuari, interfícies i desenvolupament web.</p>
                        
                        <div class="custom-btn-group mt-4">
                          <a href="#" class="btn mr-lg-2 custom-btn"><i class='uil uil-file-alt'></i> Descargar CV</a>
                          <a href="#contact" class="btn custom-btn custom-btn-bg custom-btn-link">¿Te ayudo en algo?</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-5 col-md-12 col-12">
                    <div class="about-image svg">
                        <img src="<?php echo base_url(); ?>public/images/undraw/undraw_software_engineer_lvl5.svg" class="img-fluid" alt="svg image">
                    </div>
                </div>
                ...
                <div class="row">
                  <div class="col-lg-11 text-center mx-auto col-12">
                      ...
                      <div class="col-lg-8 mx-auto">
                        <h2>Coses que he dissenyat per a agències de mitjans digitals</h2>
                      </div>

                      <div class="owl-carousel owl-theme">
                        <div class="item">
                          <div class="project-info">
                            <img src="<?php echo base_url(); ?>public/images/project/project-image01.png" class="img-fluid" alt="project image">
                          </div>
                        </div>

                        <div class="item">
                          <div class="project-info">
                            <img src="<?php echo base_url(); ?>public/images/project/project-image02.png" class="img-fluid" alt="project image">
                          </div>
                        </div>

                        <div class="item">
                          <div class="project-info">
                            <img src="<?php echo base_url(); ?>public/images/project/project-image03.png" class="img-fluid" alt="project image">
                          </div>
                        </div>

                        <div class="item">
                          <div class="project-info">
                            <img src="<?php echo base_url(); ?>public/images/project/project-image04.png" class="img-fluid" alt="project image">
                          </div>
                        </div>

                        <div class="item">
                          <div class="project-info">
                            <img src="<?php echo base_url(); ?>public/images/project/project-image05.png" class="img-fluid" alt="project image">
                          </div>
                        </div>
                      </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-5 mr-lg-5 col-12">
            ...
            <div class="contact-info d-flex justify-content-between align-items-center py-4 px-lg-5">
                <div class="contact-info-item">
                  <h3 class="mb-3 text-white">¿Te hago un presupuesto?</h3>
                  <p class="footer-text mb-0">639 53 08 53</p>
                  <p><a href="mailto:hello@company.co">andresgqjob@gmail.co</a></p>
                </div>
          ...
          <div class="col-lg-6 col-12">
            <div class="contact-form">
              <h2 class="mb-4">¿Interesado en trabajar juntos? Hablemos</h2>
              ...
              <form action="" method="get">
                <div class="row">
                  ...
                  <div class="ml-lg-auto col-lg-5 col-12">
                    <input type="submit" class="form-control submit-btn" value="Contactar">
                  </div>
                </div>
              </form>
            </div>
          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-lg-12 col-12">                                
                        <p class="copyright-text text-center">Copyright &copy; 2019 Xibalba CO . Todos los derechos reservados</p>
                        <p class="copyright-text text-center">Designed by Andres G. Quina</p>
                    </div>
    ...
    <script src="<?php echo base_url(); ?>public/js/Headroom.js"></script>
    <script src="<?php echo base_url(); ?>public/js/jQuery.headroom.js"></script>
